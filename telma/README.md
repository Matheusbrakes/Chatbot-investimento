Server.py - programa rodado no servidor das mensagens - [https://pythonprogramming.net/server-chatroom-sockets-tutorial-python-3/](Explicação de como foi feito)
